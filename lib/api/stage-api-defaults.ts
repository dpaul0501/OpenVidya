...
/**
 * Create default ConversationContent
 */
export function createDefaultConversationContent(): ConversationContent {
  return {
    type: 'conversation',
    scenario: '',
    participants: [],
 ...
 */
export function createDefaultGameContent(): GameContent {
  return {
    type: 'game',
    gameType: 'quiz',
    title: 'Learning Game',
...
export function createDefaultContent(type: SceneType): SceneContent {
  switch (type) {
    ...
    case 'conversation':
      return createDefaultConversationContent();
    case 'game':
      return createDefaultGameContent();
    default:
